...
import { sendMail, generateOTP } from "../../utils/sendMail.js";
...
export const logingIn = async (req, res) => {
  ...
  try {
    ...
    const mailObj = {
      ...
      body: `<h1> Welcome to eccomapis ${userName} </h1>
    ...
    return res
      ...
      .status(200)
      .json({ message: "Login Successful proceed to shop a product" });
  } catch (error) {
...
export const passwordResetRequest = async (req, res) => {
  ...
  try {
    ...
    await sendMail({
      ...
      body: `<p>Click on this link to reset your password </p>  <a href="https://localhost:2000/password/reset/${token}">Reset Password</a>`,
    });
    res
      .status(200)
